...
2️⃣ In Silico PCR (CRABS)

Sequences were filtered to retain only those predicted to amplify with:
...
3️⃣ Recovery of Full Sequences
...
4️⃣ Manual Curation and Primer Validation
...
5️⃣ Taxonomic Assignment (CRABS)
...
6️⃣ Dereplication and Variant Analysis
...
Collapsed into unique sequence variants
...
7️⃣ Primer Mismatch Analysis (PrimerMiner)
...
972 sequences retrieved (50 species)
...
Geneious (manual validation step)
